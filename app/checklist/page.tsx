...
const CHECKLIST_ITEMS = [
  ...
  },
  {
    ...
    letter: 'ר',
    keyword: 'רוגע',
    text: 'איזה אירוע חריג היה בשעות האחרונות? אני נסערת? מבולבלת? מוצפת?',
...
תשתמשי בשיטה האהובה עלייך להרגע, לפעמים רק חיבוק לעצמך יכול לעשות את העבודה`,
  },
  {
    ...
    expandedContent: `אולי זה משהו שאת ממש ממש לא רוצה לעשות?
אם כן, פרקי את המשימה שלך לחלקים, קחי לעצמך את החלק הכי קטן של המשימה, והכי נחמד, בצעי אותו עכשיו ותחזרי לצ'קליסט בהרגשה טובה שהדברים זזים, ואת על זה`,
  },
  {
    id: 'shin',
    letter: 'ש',
    ...
    expandedContent: `את עייפה, את פשוט עייפפפפפה.
אבל את חייבת לעשות את X ואת Y ולהספיק עוד ועוד....... חייבת???
תהיי מחוייבת קודם כל לעצמך.
ואם את צריכה שינה, אז מגיע לך! תטפלי רק במה שקריטי ותכנסי מייד לישון.
אם יש משימות קריטיות שמישהו אחר יכול לבצע - תסבירי לו שאת לא מסוגלת ותורידי את זה ממך.
פשוט תכנסי לישון מייד לפני שתפלי.
מותר לך להכנס לישון גם עם הבגדים! זה הרבה יותר טוב מלגמור את העוגה כולה ולגלות ששום דבר לא התקדם`,
  },
  {
    id: 'zayin',
    letter: 'ז',
    ...
    expandedContent: `אולי את לא באמת רעבה, אולי פשוט בא לך משהו נחמד?
מה את אוהבת לעשות, רוצה לנגן, לצייר באקריליק או בשמן? אולי לשיר? לרקוד? לצאת למרפסת לכמה דקות? לקרוא איזה כתבה מעניינת? להכניס כמה דברים לסל קניות אונליין? אולי אפילו איזה משחק בגיימבוי או צפייה בקליפ מצחיק שקיבלת?
תעשי משהו שמשמח אותך, כי מגיע לך להיות שמחה, ה' אוהב אותך שמחה, וכל המטלות הדחופות - יחכו, כי עכשיו את קודמת להכל, את מחוייבת לעצמך, אוהבת את עצמך, ורוצה לפנק את עצמך`,
  },
  {
    id: 'he',
    letter: 'ה',
  ...
  },
  {
    ...
    expandedContent: `מה מתחשק לך? סלט בריא עם תוספות? ארוחה מבושלת טעימה? לחם עם שוקולד? עוגה משבת?
פשוט תקשיבי לעצמך ותלכי עם זה.
אם חסרים לך מצרכים תרשמי על המקרר אלו מצרכים לקנות כדי שתוכלי להתארגן עם זה לפעם הבאה.
אם חסר לך זמן ופניות כדי להכין את מה שמתחשק לך, תנסי לחשוב איך תוכלי למצוא את הזמן להכין אוכל כזה לפעם הבאה (אולי עם ההכנות של שבת ולהקפיא? אולי בערב, או מוקדם בבוקר? אולי תוך כדי עם הילדים).
תני כבוד גדול למה שהגוף שלך מבקש.
הוא ראוי לזה, את ראויה לזה, את מחוייבת לעצמך לפני הכל.
אם היית מאושפזת בבית חולים איכשהו היו מסתדרים כולם.
אל תלכי בכיוון הזה, תלכי בכיוון של התחזקות, מילוי עצמי, מחוייבות כבוד ואהבה לעצמך, כשתהיי קודמת להכל, תהיי מלאה, לא תצטרכי להתאמץ כדי לתת, זה פשוט יזרום ממך הלאה, באהבה`,
  },
]
